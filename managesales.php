...
if (isset($_GET['delete'])) {
    $sno = $_GET['delete'];
    $delete = true;
    $sql = "DELETE FROM `sales` WHERE `sales_item_id` = $sno";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['snoEdit'])) {
        ...
        $sql = "INSERT INTO `sales` (`p_id`, `quantity`,`p_total`,`farmer_id`, `sales_transaction_id`) VALUES ('$p_id', '$product_quantity','$p_total','$farmers_id','$sales_transaction_id')";
        $result = mysqli_query($conn, $sql);
    ...
    <div class="main-main-main">
                    ...
                    <form action="managesales.php?sales_transaction_id=<?php echo $sales_transaction_id ?>"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="number" class="form-control" id="farmer_phoneEdit" name="farmer_phoneEdit"
        ...
        <div class="main-content" id="main-content">
                ...
                <div class="container my-4">
                    ...
                    <form action="managesales.php?sales_transaction_id=<?php echo $sales_transaction_id ?>"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="farmer_phone">Quantity</label>
                                <input required type="number" class="form-control" id="farmer_phone" name="product_quantity"
                    ...
                    <table class="table" id="myTable">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "</td>
                                    <td>" . $row['p_total'] . "</td>
                                    <td> <button class='edit btn btn-sm btn-primary' id=" . $row['sales_item_id'] . ">Edit</button> <button class='delete btn btn-sm btn-primary' id=d" . $row['sales_item_id'] . ">Delete</button>  </td>
                                    </tr>";
                            }
                            ?>
                        </tbody>
            ...
            <div class="flex-box">
                ...
                <a href="Sales_transactions_cancel.php?sales_transaction_id=<?php echo $sales_transaction_id;?>"><button class="btn btn-warning mx-4">Close</button></a>
            </div>
        </div>
    </div>
    <!-- Java Script -->
        ...
        Array.from(deletes).forEach((element) => {
            element.addEventListener("click", (e) => {
                ...
                if (confirm("Are you sure you want to delete this Product!")) {
                    console.log("yes");
                    window.location = `managesales.php?delete=${sno}&sales_transaction_id=<?php echo $sales_transaction_id; ?>`;
                }
                else {
                    console.log("no");
                }
