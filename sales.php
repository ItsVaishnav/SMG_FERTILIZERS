                    ...
                    <form action="farmers.php" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control" id="farmer_nameEdit" name="farmer_nameEdit"
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control" id="farmer_addressEdit" name="farmer_addressEdit"
                                    aria-describedby="emailHelp">
                            </div>
                    ...
                    <form action="farmers.php" method="POST">
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control" id="farmer_name" name="farmer_name"
                                    aria-describedby="emailHelp">
                            </div>
                            <div class="form-group">
                                <label for="farmer_phone">Contact No</label>
                                <input required type="number" class="form-control" id="farmer_phone" name="farmer_phone"
                                    aria-describedby="emailHelp">
                            </div>
                            <div class="form-group">
                                <label for="farmer_address">Address </label>
                                <input required type="text" class="form-control" id="farmer_address" name="farmer_address"
                                    aria-describedby="emailHelp">
                            </div>
